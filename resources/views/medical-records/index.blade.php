        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-8 slide-up">
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    <a href="{{ route('medical-records.index') }}" class="nav-link flex items-center px-4 py-2 rounded-lg text-white hover:bg-white/30 transition-all duration-300 font-semibold">
            ...
            <div class="bg-white rounded-xl p-6 mb-8 search-container">
                <div class="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
                    ...
                    <button onclick="openNewRecordModal()" class="btn-primary">
                ...
                <div class="p-6">
                    ...
                    <form id="newRecordForm">
                        ...
                        <div class="flex justify-end space-x-3">
                            <button type="button" onclick="closeNewRecordModal()" class="btn-secondary">
                                Annuler
                            </button>
        ...
        function createRecordCard(record, index) {
            ...
            card.innerHTML = `
                ...
                <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                    ...
                    <button onclick="viewRecordDetails(${record.id})" class="btn-outline">
                        Voir détails
                    </button>
                </div>
            `;
