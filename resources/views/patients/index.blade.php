        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-8 slide-up">
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    <a href="{{ route('patients.index') }}" class="nav-link flex items-center px-4 py-2 rounded-lg text-white hover:bg-white/30 transition-all duration-300 font-semibold">
        ...
        function createPatientCard(patient, index) {
            ...
            card.innerHTML = `
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button onclick="viewPatientDetails(${patient.id})" class="btn-outline">
                        Voir détails
                    </button>
                </div>
            `;
